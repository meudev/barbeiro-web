            ...
            <Flex h='20' alignItems='center' justifyContent='space-between' mx='8'>
                <Link href='/dashboard'>
                    <Flex cursor='pointer' userSelect='none' flexDirection='row'>
                        <Text fontSize='2xl' fontFamily='monospace' fontWeight='bold' color="white">Baber</Text>
    ...
    return (
        ...
        >
            ...
            <Flex flexDirection='row'>
                <Text ml={8} fontSize='2xl' fontFamily='monospace' fontWeight='bold' color="white">Baber</Text>
                <Text fontSize='2xl' fontFamily='monospace' fontWeight='bold' color="button.cta">PRO</Text>
            </Flex>
        </Flex>
    )
